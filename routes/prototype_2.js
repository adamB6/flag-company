...
// Route to handle the GET request for prototype_2
router.get('/', function(req, res, next) {
    res.render('prototype_2', { title: 'Prototype 2', states: states, selectedState: null });
});

// Route to handle the POST request for prototype_2
router.post('/', function(req, res, next) {
    var selectedState = req.body.selectedState;
    res.render('prototype_2', { title: 'Prototype 2', states: states, selectedState: selectedState });
});
